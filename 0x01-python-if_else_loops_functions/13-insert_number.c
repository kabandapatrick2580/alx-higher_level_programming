...
/**
 * custom_insert_node - Inserts a value
 * into a sorted singly custom_linked_list.
 * @custom_head: Pointer to the head of the custom_linked_list.
 * @custom_value: Value to be inserted.
 *
 * Return: The address of the new custom_node,
 * or NULL if it failed.
 */
custom_list_t *custom_insert_node(custom_list_t **custom_head,
		int custom_value)
{
	...
	/*
	 * If the custom_linked_list is empty or the custom_value
	 * < the custom_head, insert at the beginning
	 *
	 */
	...
	/*
	 * Traverse the custom_linked_list to
	 * find the appropriate position
	 */
	custom_current = *custom_head;
	while (custom_current->custom_next != NULL &&
			custom_current->custom_next->custom_value < custom_value)
		custom_current = custom_current->custom_next;

	/*
	 * Insert the new custom_node in the
	 * middle or at the end of the custom_linked_list
	 *
	 */
